...
export default function page() {
    return (
        <section className="flex flex-wrap items-center h-auto max-w-4xl mx-auto my-32 lg:my-0 lg:h-screen">
            <div
                id="profile"
                className="w-full mx-6 bg-white rounded-lg shadow-2xl opacity-75 lg:mx-0 lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none"
            >
                <div className="p-4 text-center md:p-12 lg:text-left">
                    ...
                    <div className="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6 lg:w-full lg:pb-0">
                        <a
                            className="link"
                            href="#"
